...
const cardData = [
    { image: about1, title: ' Éli Breton', subtitle: 'Architecture & Founder', desc: 'Éli Breton is an architecture graduate.He is the founder of CHT and is very interested in blockchain technology and its application. With Real Estate tokenization he hopes to alleviate the housing crisis happening in Canada.', percent: '-1.26' },
    { image: about2, title: ' Cyril Yadak', subtitle: 'Real Estate Developer', desc: 'Cyril Yadak is a real estate developer passionate about cryptocurrencies and developing emerging regions of Canada. He’s a licensed builder and has many years of experience with constructing single family homes', percent: '-1.55' },
    { image: about3, title: ' Umair Riaz', subtitle: 'Blockchian Lead dev', desc: 'Umair Riaz is a Web3 Blockchian Developer and consultant working closely on the development of the token. His network of choice is Eth for its security. He is also working as Smart Contract Auditor.', percent: '0.0099' },
    ...
    return (
        <>
            {cardData.map((data, index) => (
                <div className="col-xl-6 col-lg-6 col-md-6 m-b30" key={index}>
