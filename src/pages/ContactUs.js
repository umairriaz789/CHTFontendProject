                            ...
                            <div className="col-xl-5 col-lg-5 m-b30">
                                <div className="info-box">
                                    <div className="info">
                                        ...
                                        <p className="font-18">Our team will get back to you within 24 hours.</p>
                                    </div>
                                        ...
                                        <div className="widget widget_getintuch">
                                            <ul>
                                                <li>
                                                    ...
                                                    <span>+191XXXXXXXXX</span>
                                                </li>
                                                <li>
                                                    <i className="fa fa-envelope"></i>
                                                    <span>info@cht.com<br />cht@gmail.com</span>
                                                </li>
                                                <li>
                                                    <i className="fas fa-map-marker-alt"></i>
                                                    <span>Address<br />Canada</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
